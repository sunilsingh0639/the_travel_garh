...
//       <div style={{ background: '#fff', padding: `45px ${pad}px` }}>
//         <h1 style={{ fontSize: titleSize, fontWeight: 'bold', color: '#000', lineHeight: 1.3, margin: 0 }}>
//           {headingTitle}
//         </h1>
//         <p style={{ fontSize: descSize, lineHeight: 1.9, color: '#555', marginTop: 18, maxWidth: 800 }}>
//           {description}
//         </p>
//       </div>
...
//         </h2>
//         <div style={{ marginTop: 20, minHeight: listHeight }}>
//           {loading ? (
